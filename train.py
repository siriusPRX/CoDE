...
parser.add_argument('--DATASET', type=str, default='New_Training_Data',
...
parser.add_argument('--ENABLE-AUG-TYPES', type=list, default=[3, 4, 5, 6],
...
def main():
    ...
    train_batch_loader = DataLoader(name=args.DATASET, mode='train', ratio=args.RATIO, normalize=args.NORMALIZE,
                                    input_size=args.INPUT_SIZE, batch_size=args.TRAIN_BATCH_SIZE,
    ...
    val_batch_loader = DataLoader(name=args.DATASET, mode='val', ratio=args.RATIO, normalize=args.NORMALIZE,
                                  input_size=args.INPUT_SIZE, batch_size=args.VAL_BATCH_SIZE,
